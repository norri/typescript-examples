...
describe("Books Routes", () => {
  ...
  test("GET /api/v1/books should return books", async () => {
    const booksList: Book[] = [{ title: "Book 1" }, { title: "Book 2" }];
    (bookService.listAll as jest.Mock).mockResolvedValue(booksList);
